{
  csfx = {
    ...
    controlPlane = {
      ...
      api-gateway = {
        amd64 = {
          ...
          sha256 = "5bafabf691124c18d9fe9b1d948160b43aa3cf90642473cd3322f264805db9ae";
        };
        arm64 = {
          url    = "https://github.com/CSFX-cloud/CSFX-Core/releases/download/v0.2.2-alpha.571/csfx-cp-api-gateway-arm64";
          sha256 = "c60f1107dbf286ca07da070fcbd5eb81fe834ebe4c24320cae5023f059000bd6";
        };
      };
      registry = {
        amd64 = {
    ...
    frontend = {
      ...
      sha256 = "86d66c9284f3ef5b32f3ac482039b84bc0cec4d540c10c4a272073def7224815";
    };
  };
}
